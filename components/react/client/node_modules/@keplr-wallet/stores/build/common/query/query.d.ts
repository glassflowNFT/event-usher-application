...
export declare abstract class ObservableQueryBase<T = unknown, E = unknown> {
    ...
    private _error?;
    private _isStarted;
    private _pendingOnStart;
    private readonly queryCanceler;
    private readonly onStartCanceler;
    private readonly queryControllerConceler;
    ...
    protected abstract fetchResponse(abortController: AbortController): Promise<{
