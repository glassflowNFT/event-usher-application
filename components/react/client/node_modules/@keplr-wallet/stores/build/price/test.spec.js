...
describe("Test coin gecko price store", () => {
    const createMockCoingeckoServer = (delay = 50) => {
        const testPrices = {
    ...
    it("test basic query", () => __awaiter(void 0, void 0, void 0, function* () {
        const { port, closeServer, getTestPrice } = createMockCoingeckoServer();
        const priceStore = new index_1.CoinGeckoPriceStore(new common_1.MemoryKVStore("test"), {
            usd: {
                currency: "usd",
                symbol: "$",
                maxDecimals: 2,
    ...
    it("test that price store remembers last used coin ids", () => __awaiter(void 0, void 0, void 0, function* () {
        const abortSpy = jest.spyOn(AbortController.prototype, "abort");
        const store = new common_1.MemoryKVStore("test");
        // Query cosmos,osmosis,regen price
        yield (() => __awaiter(void 0, void 0, void 0, function* () {
            const { port, closeServer, getTestPrice, getServerRespCount, } = createMockCoingeckoServer();
            const priceStore = new index_1.CoinGeckoPriceStore(store, {
                usd: {
                    currency: "usd",
                    symbol: "$",
                    maxDecimals: 2,
    ...
    it("test that price store not make multiple queries in sync loop (with no throttling)", () => __awaiter(void 0, void 0, void 0, function* () {
        const abortSpy = jest.spyOn(AbortController.prototype, "abort");
        const { port, closeServer, getTestPrice, getTestPrices, getServerRespCount, } = createMockCoingeckoServer();
        const priceStore = new index_1.CoinGeckoPriceStore(new common_1.MemoryKVStore("test"), {
            usd: {
                currency: "usd",
                symbol: "$",
        ...
        const disposer2 = mobx_1.autorun(() => {
            const tests = getTestPrices();
            for (const coinId of Object.keys(tests)) {
                priceStore.getPrice(coinId);
            }
