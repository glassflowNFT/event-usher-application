...
export declare class ObservableQuerySecret20Balance extends ObservableSecretContractChainQuery<{
    ...
    constructor(kvStore: KVStore, chainId: string, chainGetter: ChainGetter, apiGetter: () => Promise<Keplr | undefined>, contractAddress: string, bech32Address: string, viewingKey: string, querySecretContractCodeHash: ObservableQuerySecretContractCodeHash);
