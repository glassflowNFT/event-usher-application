...
describe("display status", () => {
    beforeAll(() => (0, test_utils_1.act)(() => {
        (0, react_1.render)(react_2.default.createElement(components_1.WalletManagerProvider, { defaultChainId: types_1.ChainInfoID.Athena2, enabledWalletTypes: [types_1.WalletType.Keplr, types_1.WalletType.WalletConnectKeplr] },
